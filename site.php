<?php 
	...
	use \Projeto_Ecommerce\Model\Address;
	use \Projeto_Ecommerce\Model\User;
	use \Projeto_Ecommerce\Model\Order;
	use \Projeto_Ecommerce\Model\OrderStatus;
	...
	$app->get("/boleto/:idorder", function($idorder){
		...
		$dadosboleto["endereco1"] = $order->getaddress() . " " . $order->getdescomplement() . " " . $order->getdesdistrict();
